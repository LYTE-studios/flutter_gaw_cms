...
class _LanguageButtonState extends ConsumerState<LanguageButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return MenuAnchor(
      ...
      style: MenuStyle(
        backgroundColor: MaterialStateProperty.all(GawTheme.clearBackground),
      ...
      menuChildren: [
        MenuItemButton(
          ...
          style: ButtonStyle(
            backgroundColor:
                MaterialStateProperty.all(GawTheme.clearBackground),
            overlayColor: MaterialStateProperty.resolveWith<Color>(
              (Set<MaterialState> states) {
                ...
                return GawTheme.clearBackground; // Default for other states
              },
            ),
            shape: MaterialStateProperty.all(
              RoundedRectangleBorder(
