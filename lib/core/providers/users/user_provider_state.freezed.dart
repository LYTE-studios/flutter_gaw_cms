...
part of 'user_provider_state.dart';
...
class _$userProviderStateImpl implements userProviderState {
  ...
  @override
  String toString() {
    return 'UserProviderState(loading: $loading, id: $id, firstName: $firstName, lastName: $lastName, email: $email, profilePictureUrl: $profilePictureUrl, profilePicture: $profilePicture, description: $description, phoneNumber: $phoneNumber, language: $language, dateOfBirth: $dateOfBirth, address: $address)';
  }
...
abstract class userProviderState implements UserProviderState {
  factory userProviderState(
      ...
      final String? language,
      final DateTime? dateOfBirth,
      final Address? address}) = _$userProviderStateImpl;
